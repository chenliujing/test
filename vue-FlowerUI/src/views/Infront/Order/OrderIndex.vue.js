...
const CompleteOrderAsync = async (id) => {
...
const filteredInfo = computed(() => {
    ...
    return data.filter(item => {
        return (item.orderId.includes(searchQuery.value) ||
...
const fetchOrderItems = async () => {
    if (userId) {
        try {
            const response = await getOrderItems(Number(userId));
...
function __VLS_template() {
    ...
    [ElTableColumn, ElTableColumn,];
    // @ts-ignore
    const __VLS_99 = __VLS_asFunctionalComponent(__VLS_98, new __VLS_98({ label: ("地址"), }));
    const __VLS_100 = __VLS_99({ label: ("地址"), }, ...__VLS_functionalComponentArgsRest(__VLS_99));
    ({}({ label: ("地址"), }));
    __VLS_elementAsFunction(__VLS_intrinsicElements.template, __VLS_intrinsicElements.template)({});
    {
    ...
    [ElTableColumn, ElTableColumn,];
    // @ts-ignore
    const __VLS_105 = __VLS_asFunctionalComponent(__VLS_104, new __VLS_104({ prop: ("row.status"), label: ("状态"), }));
    const __VLS_106 = __VLS_105({ prop: ("row.status"), label: ("状态"), }, ...__VLS_functionalComponentArgsRest(__VLS_105));
    ({}({ prop: ("row.status"), label: ("状态"), }));
    __VLS_elementAsFunction(__VLS_intrinsicElements.template, __VLS_intrinsicElements.template)({});
    {
    ...
    [ElTableColumn, ElTableColumn,];
    // @ts-ignore
    const __VLS_111 = __VLS_asFunctionalComponent(__VLS_110, new __VLS_110({ label: ("操作"), }));
    const __VLS_112 = __VLS_111({ label: ("操作"), }, ...__VLS_functionalComponentArgsRest(__VLS_111));
    ({}({ label: ("操作"), }));
    __VLS_elementAsFunction(__VLS_intrinsicElements.template, __VLS_intrinsicElements.template)({});
    {
        ...
        [ElButton, ElButton,];
        // @ts-ignore
        const __VLS_117 = __VLS_asFunctionalComponent(__VLS_116, new __VLS_116({ ...{ 'onClick': {} }, type: ("primary"), icon: ((__VLS_ctx.Delete)), }));
        const __VLS_118 = __VLS_117({ ...{ 'onClick': {} }, type: ("primary"), icon: ((__VLS_ctx.Delete)), }, ...__VLS_functionalComponentArgsRest(__VLS_117));
        ({}({ ...{ 'onClick': {} }, type: ("primary"), icon: ((__VLS_ctx.Delete)), }));
        let __VLS_122;
        const __VLS_123 = {
            onClick: (...[$event]) => {
                __VLS_ctx.CancelOrderItem(row.id);
                // @ts-ignore
                [Delete, CancelOrderItem,];
            }
        };
        ...
        [ElButton, ElButton,];
        // @ts-ignore
        const __VLS_125 = __VLS_asFunctionalComponent(__VLS_124, new __VLS_124({ ...{ 'onClick': {} }, ...{ style: ({}) }, type: ("success"), round: (true), }));
        const __VLS_126 = __VLS_125({ ...{ 'onClick': {} }, ...{ style: ({}) }, type: ("success"), round: (true), }, ...__VLS_functionalComponentArgsRest(__VLS_125));
        ({}({ ...{ 'onClick': {} }, ...{ style: ({}) }, type: ("success"), round: (true), }));
        let __VLS_130;
        const __VLS_131 = {
            onClick: (...[$event]) => {
                __VLS_ctx.CompleteOrderAsync(row.id);
                // @ts-ignore
                [CompleteOrderAsync,];
            }
        };
    ...
    const __VLS_internalComponent = __VLS_defineComponent({
        setup() {
            return {
                ...
                CompleteOrderAsync: CompleteOrderAsync,
...
;
//# sourceMappingURL=OrderIndex.vue.js.map